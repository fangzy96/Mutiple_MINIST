...
if __name__ == '__main__':
    ...
    rnd_f_clf = GridSearchCV(RandomForestClassifier(), tuned_parameters, scoring="accuracy", n_jobs=-1)
    ...
    pd.DataFrame(res).to_csv('random_forest_pred.csv', index=False, encoding="utf-8")
